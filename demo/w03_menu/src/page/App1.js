    ...
    <section class="menu">
          ...
          <div class="section-center">
            <article class="menu-item">
              <img src="/menu-theme/images/my-1.jpg" alt="eggs" class="photo" />
              <div class="item-info">
                <header>
                  <h4>eggs</h4>
            ...
            <article class="menu-item">
              <img src="./images/my-2.jpg" alt="big" salad="" class="photo" />
              <div class="item-info">
                <header>
                  <h4>big salad</h4>
                  <h4 class="price">12.59</h4>
            ...
            <article class="menu-item">
              <img src="./images/my-3.jpg" alt="fried" dish="" class="photo" />
              <div class="item-info">
                <header>
                  <h4>fried dish</h4>
                  <h4 class="price">12.59</h4>
